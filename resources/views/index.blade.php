    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row align-items-center">
                <div class="col-xl-7">
                    <h1 class="animate__animated animate__fadeInUp">La vente de tickets WiFi, <br><span style="color: #10b981;">à portée de main.</span></h1>
        ...
        <section id="contact" class="contact" style="padding: 100px 0;">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row g-5" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-5">
                        <div class="info-card p-5 modern-card h-100" style="background: rgba(16, 185, 129, 0.05); border: 1px solid rgba(16, 185, 129, 0.2);">
                    ...
                    <div class="col-lg-7">
                        <div class="contact-card p-5 modern-card" style="background: rgba(16, 185, 129, 0.05); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 35px !important;">
